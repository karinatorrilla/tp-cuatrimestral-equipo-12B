            ...
            try
            {
                ...
                else if (Request.QueryString["darturno"] != null)
                {
                    ...
                    if (idturno > 0)
                    {
                        ...
                        emailService.armarCorreo(txtEmail.Text, "Confirmación de Turno : "+idturno, cuerpoMail);
                        emailService.enviarEmail();
